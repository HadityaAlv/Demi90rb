...
WebUI.setText(findTestObject('Object Repository/Login/Page_Swag Labs/input_Swag Labs_user-name'), GlobalVariable.user4)
...
WebUI.verifyElementText(findTestObject('Login/Page_Swag Labs/span_Products'), 'Products')
